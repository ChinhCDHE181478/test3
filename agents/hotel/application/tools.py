...
from shared.models import HotelSearchCriteria, Plan, MultiHotelSearchCriteria
...
\nSummary of the conversation so far (if any):\n{summary}"""
    ...
    return Command(
        ...
        update={
            ...
            + [
                ToolMessage(
                    content="Transfer to Hotel Agent",
                    tool_call_id=tool_call_id,
                    name="recommend_hotels",
                )
            ],
...
recommend_hotels_multi.description = "Extract multiple hotel search segments from the conversation and transfer to Hotel Agent."
