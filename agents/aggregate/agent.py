...
from hotel.application.graph import create_hotel_agent
from shared.data_stream.stream import CustomDataStreamConfig, StreamResponse
from shared.infrastructure.connection_pool import get_connection_pool
...
class Agent:
    ...
    async def _async_stream(
        ...
        async for data_part in StreamResponse(
            ...
            messages_streamable_nodes=["chatbot"],
